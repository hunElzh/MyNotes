...
> 结论：通过Proxy.getProxyClass(参数) 方法，将接口Class类作为参数传入，即可动态生成代理对象实例。

![32sd092349afjtd](E:\Study\Mynotes\MyNotes\img\32sd092349afjtd.png)
...
> 至此，我们已经通过接口，动态地获取到了 代理Class，接下来只需要通过反射即可得到代理对象
